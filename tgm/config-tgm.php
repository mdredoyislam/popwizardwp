 ...
 * TGM
 */
class PopWizardWpequiredPlugins {


	public function __construct() {
		add_action( 'tgmpa_register', array( $this, 'popwizardwp_register_required_plugins' ) );
	}

	public function popwizardwp_register_required_plugins() {

		$plugins = array(

			
			array(
				'name'               => esc_html__( 'Piklist', 'managecustompost' ),
				'slug'               => 'piklist',
				'required'           => true,
				'force_activation'   => false,
				'force_deactivation' => false,
				'external_url'       => plugin_dir_path(__FILE__)."/plugins/piklist.zip",
			),
